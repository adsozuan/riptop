...
void riptop::AcquisitionThread::operator()(Sender<std::vector<ProcessInfo>> process_sender, Sender<SystemInfoDynamicData> system_info_sender, SystemDataService * system_data_service, Ui * main_ui)
{
    while (true)
    {
